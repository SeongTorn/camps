...
@section('main')
<section class="engine"><a href="https://mobirise.me/u">bootstrap responsive templates</a></section><section class="header12 cid-qRjJpeGsr6 mbr-fullscreen mbr-parallax-background" id="header12-4v">
        ...
        <div class="icons-media-container mbr-white">
          <div class="card col-12 col-md-6 col-lg-4">
            <div class="icon-block">
              <a href="https://mobirise.com/"><span class="mbr-iconfont mbri-cash"></span></a>
            </div>
          ...
          <div class="card col-12 col-md-6 col-lg-4">
            <div class="icon-block">
              <a href="https://mobirise.com/"><span class="mbr-iconfont mbri-success"></span></a>
            </div>
          ...
          <div class="card col-12 col-md-6 col-lg-4">
            <div class="icon-block">
              <a href="https://mobirise.com/"><span class="mbr-iconfont mbrib-paper-plane"></span></a>
            </div>
  ...
  <div class="container">
    ...
    <div class="row py-2 justify-content-center">
      <div class="col-12 col-lg-6  col-md-8 " data-form-type="formoid">
        ...
        <form class="mbr-form" action="https://mobirise.com/" method="post" data-form-title="Mobirise Form"><input type="hidden" name="email" data-form-email="true" value="xJfGAwSvro2JzvwT+k8y+m783U87gqn/4W0s6AjRu9PbxMbhHkg6hhaG1Vhsv3sv9vP7v37khAymcoqII/prFHlos05Y1eMrLvJDfRBtoMp8qhkqAf/Xwp8mwpSM8GDe" data-form-field="Email">
...
<section class="mbr-section content4 cid-qZDEKhAMAl" id="content4-bd">
  <div class="container">
...
<section class="mbr-section content4 cid-qRjLjzvcbR" id="content4-50">
  <div class="container">
    <div class="media-container-row">
      <div class="title col-12 col-md-8">
        <h2 class="align-center pb-3 mbr-fonts-style display-2">&nbsp;</h2>
