<section class="features9 cid-qZfY4XgWNP">
  <div class="container">
      ...
      <div class="card p-3 col-12 col-md-6">
        <div class="media-container-row">
          ...
          <div class="card-box">
            ...
            <p class="mbr-text mbr-fonts-style display-7">Register all your children at once, and for multiple camps at the same time. Only takes a few minutes.&nbsp;</p>
          </div>
        </div>
      </div>
    </div>
